...
\begin{enumerate}
	...
	\item Sea $M$ un $A$-módulo, diremos que es \strong{noetheriano} si todos sus $A$-submódulos son finitamente generados.
		\begin{enumerate}
...
\begin{enumerate}
	...
	\item Se dice que un $A$-módulo $M$ es \strong{indescomponible} si no posee dos submódulos propios $N_1, N_2$
