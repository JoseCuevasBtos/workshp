...
\begin{enumerate}
	...
	\item Sea $C'$ la cónica afín dada por la ecuación:
		\begin{equation}
		...
		\begin{enumerate}
			...
			\item Pruebe que si $C'$ es suave y tiene un punto (racional) $(x_0, y_0) \in C(k)$,
				entonces $\overline{C'} \cong \PP^1(k)$, donde $\overline{C'}$ es su clausura proyectiva, es decir, las
				soluciones en $\PP^2(k)$ de
				\[
	...
	\item Describa \emph{todos} los puntos $\Q$-racionales de $x^2 + y^2 = 2$ parándose en $(1, 1)$.

	\item Encuentre los \textquote{puntos al infinito} de las siguientes curvas afines:
		\begin{enumerate}
			\item $3x - 7y + 5 = 0$.
			\item $x^2 + xy - 2y^2 + x - 5y + 7 = 0$.
			\item $x^3 + x^2y - 3xy^2 - 3y^3 + 2x^2 - 2 + 5 = 0$.
		\end{enumerate}
