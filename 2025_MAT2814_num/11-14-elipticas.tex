...
\begin{enumerate}
	...
	\item Sea $C \colon y^2 = f(x) := x^3 + b_2x^2 + b_4x + b_6$ una curva afín con clausura proyectiva $\overline{C}$.
		\begin{enumerate}
			...
			\item Pruebe que $o$ es un punto suave y, más generalmente, calcule cuales son los posibles puntos singulares.
				Dé un ejemplo concreto donde efectivamente los puntos que satisfagan esta propiedad sean los singulares.
		\end{enumerate}
